...
DELETE FROM spell_linked_spell WHERE spell_trigger IN (63645,63644,-87336);
...
INSERT INTO `spell_linked_spell` (`spell_trigger`, `spell_effect`, `type`, `req_aura`, `comment`)  VALUES (-87336, -81209, 0, 0, 'Chakra: Chastise - remove when Reset talents');
INSERT INTO `spell_linked_spell` (`spell_trigger`, `spell_effect`, `type`, `req_aura`, `comment`)  VALUES (-87336, -81208, 0, 0, 'Chakra: Serenity - remove when Reset talents');
INSERT INTO `spell_linked_spell` (`spell_trigger`, `spell_effect`, `type`, `req_aura`, `comment`)  VALUES (-87336, -81206, 0, 0, 'Chakra: Sanctuary - remove when Reset talents');