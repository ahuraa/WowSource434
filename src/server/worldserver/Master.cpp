...
int Master::Run()
{
	...
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "-------------------------------------------------------------");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "-                                                           -");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "-    TinyCore 4.3.4 Developered By TinyCore Support Team    -");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "-                                                           -");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "- Website : www.tinycore.net                                -");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "- Email   : lizard.tiny@gmail.com                           -");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "-                                                           -");
	sLog->outInfo(LOG_FILTER_WORLDSERVER, "-------------------------------------------------------------");
